...
public class Orden extends JFrame{
    ...
    public Orden(Jugadores nombrej) {
    ...
    public JLabel Jugador1(){
        nombreJug1 = new JLabel("Player 1 : "+ nombrej.getJugador1Nombre() +" Elije a tus personajes");
                ...
                switch (index1){
                    case 0:
                        if(seleccionar1.getSelectedItem() == "Guerrero Mario Rojo"){
                            ...
                            nombrej.Guerreros[0] = jugPer1.getText();
                            nombrej.Ordenar[0] = 1;
                    ...
                    case 1:
                        if(seleccionar1.getSelectedItem() == "Guerrero Mario Rojo"){
                            ...
                            seleccionar1.removeItemAt(seleccionar1.getSelectedIndex());
                            nombrej.Guerreros[2] = jugPer2.getText();
                            nombrej.Ordenar[2] = 1;
                            index1++;
                        }else if(seleccionar1.getSelectedItem() == "Mago Mario Rojo"){
                            jugPer2.setText((String)seleccionar1.getSelectedItem());
                    ...
                    case 2:
                        if(seleccionar1.getSelectedItem() == "Guerrero Mario Rojo"){
                            ...
                            seleccionar1.removeItemAt(seleccionar1.getSelectedIndex());
                            nombrej.Guerreros[4] = jugPer3.getText();
                            nombrej.Ordenar[4] = 1;
                            index1++;
                        }else if(seleccionar1.getSelectedItem() == "Mago Mario Rojo"){
                            jugPer3.setText((String)seleccionar1.getSelectedItem());
                ...
                switch (index1){
                    case 3:
                        if(seleccionar2.getSelectedItem() == "Guerrero Mario Azul"){
                            ...
                            nombrej.Guerreros[1] = jugPer11.getText();
                            nombrej.Ordenar[1] = 4;
                            index1++;
                    ...
                    case 4:
                        if(seleccionar2.getSelectedItem() == "Guerrero Mario Azul"){
                            ...
                            seleccionar2.removeItemAt(seleccionar2.getSelectedIndex());
                            nombrej.Guerreros[3] = jugPer22.getText();
                            nombrej.Ordenar[3] = 4;
                            index1++;
                        }else if(seleccionar2.getSelectedItem() == "Mago Mario Azul"){
                            jugPer22.setText((String)seleccionar2.getSelectedItem());
                    ...
                    case 5:
                        if(seleccionar2.getSelectedItem() == "Guerrero Mario Azul"){
                            ...
                            seleccionar2.removeItemAt(seleccionar2.getSelectedIndex());
                            nombrej.Guerreros[5] = jugPer33.getText();
                            nombrej.Ordenar[5] = 4;
                            index1++;
                        }else if(seleccionar2.getSelectedItem() == "Mago Mario Azul"){
                            jugPer33.setText((String)seleccionar2.getSelectedItem());
    ...
    public JLabel Jugador2(){
        nombreJug2 = new JLabel("Player 2 : "+ nombrej.getJugador2Nombre()+" Elije a tus personajes");
        ...
        jugar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if(jugPer3.getText()!= "" && jugPer33.getText()!=""){
                    ...
                    panel = new PanelTablero(nombrej);
                    
                    to = new RelojSalida(nombrej,panel);
                    to.start(0, 1000);
                    dispose();
                }else{
                    JOptionPane.showMessageDialog(null, "Primero escoje a tus personajes");
                }
            }
        });
        return jugar;
