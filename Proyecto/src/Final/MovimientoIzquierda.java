...
public class MovimientoIzquierda extends Thread {
    ...
    public MovimientoIzquierda(int cantidad, PanelTablero panel, Jugadores nombrej) {
        this.panel = panel;
    ...
    public void MoverIzq(int cantidad) {
        ...
        if (Comprobar()) {
            ...
            cantidad = 0;
            panel.vecL[a][b] = 0;
            panel.Tablero[a][b].setIcon(null);
            System.out.println(panel.vecL[a][b]);
            if (panel.turno == 1 || panel.turno == 3 || panel.turno == 5) {
